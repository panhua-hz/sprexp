...
<body>
	<h1>
		...
		<!-- this url /login?logout only redirect, not logout actually. -->
		<a href="<c:url value="/logout" />"><font size="2">logout1</font></a>
		<a href="<c:url value="/login?logout" />"><font size="2">logout2</font></a>
		<!-- this sf:form logout will truly logout and redirect to /login?logout -->
